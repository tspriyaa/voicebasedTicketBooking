...
TO run the bot host an api that could add user data and POST. To use the sms functionality register on nexmo site and fill in the api values from there on smsSender class